...
public class BangLuongNhanVien implements Comparable<BangLuongNhanVien>, Serializable {


	/**
	 * 
	 */
	private static final long serialVersionUID = 6454290479223130115L;
	@Id
	@Column(name = "maBangLuong", nullable = false)
	...
	public double khauTruTuBaoHiemYTeVaBaoHiemXaHoi() {
		...
		if(nhanVien.getBHXH().equalsIgnoreCase("tham gia")) {
			baoHiemXaHoi = 0.08;
		}
		if(nhanVien.getBHYT().equalsIgnoreCase("tham gia")) {
			baoHiemYTe = 0.015;
		}
