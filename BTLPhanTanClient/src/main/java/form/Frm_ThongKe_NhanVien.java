...
public class Frm_ThongKe_NhanVien extends javax.swing.JPanel {
    ...
    Socket socket;
    public Frm_ThongKe_NhanVien(DataOutputStream out, ObjectInputStream in, Socket socket) {
    	this.out = out;
		this.in = in;
		this.socket = socket;
        initComponents();
...
//            		ArrayList<Vector<String>> ds=  BangLuongNhanVien_Dao.layDanhSachThongKeTopNNhanVien(tuThang, tuNam, toiThang, toiNam, 5, "desc", "LuongThucNhan");
            		ArrayList<Vector<String>> ds=  null;
                	pnBieuDoCot.xuatBieuDo(ds, 0);
                	dayDuLieuVaoBang(ds);
            	}else if(tieuChiHai == 1) {
//            		BangLuongNhanVien_Dao.layDanhSachThongKeTopNNhanVien(tuThang, tuNam, toiThang, toiNam, 5, "asc", "LuongThucNhan");
        		...
        		if(tieuChiHai == 0){
//        			 BangLuongNhanVien_Dao.layDanhSachThongKeTopNNhanVien(tuThang, tuNam, toiThang, toiNam, 5, "desc", "NgayLam");
                 	
            		ArrayList<Vector<String>> ds= null;
            		pnBieuDoCot.xuatBieuDo(ds, 0);
                	dayDuLieuVaoBang(ds);
            	}else if(tieuChiHai == 1) {
//            		 BangLuongNhanVien_Dao.layDanhSachThongKeTopNNhanVien(tuThang, tuNam, toiThang, toiNam, 5, "asc", "NgayLam");
