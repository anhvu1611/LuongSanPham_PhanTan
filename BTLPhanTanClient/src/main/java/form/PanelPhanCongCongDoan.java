 ...
 * @author Vu
 */
public class PanelPhanCongCongDoan extends javax.swing.JPanel {
	public GUI_APP app;
	/**
...
//		addSearchListenerSanPham();
	...
	private void initComponents() {
		...
		btnSua.setPreferredSize(btnChonTatCa.getPreferredSize());
		btnXoaPhanCong.setPreferredSize(btnChonTatCa.getPreferredSize());
