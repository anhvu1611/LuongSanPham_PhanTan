...
public class frm_SanPham_CapNhat extends javax.swing.JPanel {
    ...
    public frm_SanPham_CapNhat(DataOutputStream out, ObjectInputStream in, Socket socket) throws IOException {
    	this.outData = out;
		this.in = in;
		this.socket = socket;
        initComponents();
...
//				qlSanPham.capNhatSanPham(taoDoiTuongSanPham());
				if(isSuccess) {
	...
	private void duaDuLieuSanPhamVaoSver() throws IOException {
...
//	    dchThoiHanSXDuKien.getDate().getDay();
	    LocalDate thoiGianSanXuatDuKien = LocalDate.of(dchThoiHanSXDuKien.getDate().getYear(), dchThoiHanSXDuKien.getDate().getMonth(), dchThoiHanSXDuKien.getDate().getDay());
	    ...
	    SanPham sanPham = new SanPham(maSP, tenSP, giaThanh, thoiGianSanXuatDuKien, chatGo, anh, kichThuoc, soLuong, khoiLuong);
...
//		}
    ...
    private void tglThemActionPerformed(java.awt.event.ActionEvent evt) throws IOException {//GEN-FIRST:event_tglThemActionPerformed
        // TODO add your handling code here:
        if(tglThem.isSelected()){
...
//        pnHinhNen.setNewBackground("");
    ...
    private void dienMaSanPhamTiepTheoVaoForm() throws IOException {
        outData.writeUTF("GD_SANPHAM_CAPNHAT");
        outData.writeInt(3);
        outData.flush();
		try {
