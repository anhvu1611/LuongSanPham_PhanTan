    ...
    */
    ...
    public class Dialog_ChiTietLuongCongNhan extends javax.swing.JDialog {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 4827390647398257908L;
...
//        }
        ...
        private void loadBangChamCongCongNhan(int thang, String ma) {
            ...
            CongNhan cn = null;
//            		congNhan_dao.timCongNhanBangMa(ma);
            ...
            ArrayList<BangChamCongCongNhan> bcccn = null;
//            		bangCCCN_dao.timChamCongTheoThangVaTheoMa(ma,thang);
...
//            Date thangCham = (Date) rowData.get(9);
        ...
        private void loadBangChamCongCongNhan(String maCongNhan, Date ngayCham) {
        	CongNhan cn = null;
//        			CongNhan_Dao.timCongNhanBangMa(maCongNhan);
        	ChuyenMon chuyenMon = null;
            String chuyenMonCN = cn.getChuyenMon().getTenChuyenMon();
            double heSoLuongTheoChuyenMon;
            if(chuyenMonCN.equalsIgnoreCase("Cắt gỗ")) {
            ...
            ArrayList<Vector<String>> bcccn = null;
//            		bangCCCN_dao.layDanhSachChamCongTheoMaCongNhanVaThang(maCongNhan, ngayCham.getMonth()+1);
            int z=0;
